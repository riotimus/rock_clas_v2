...
ctypes.windll.user32.MessageBoxW(0, "Now you can select lines..press shift+click to define point possition", "Poly lines", 1)
...
vis.create_window(window_name='rock', width=420, height=340)
#window_name='cloud point', width=820, height=680
