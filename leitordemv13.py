...
#pcd.points = o3d.utility.Vector3dVector([colxadj,colyadj,colz])
pcd.colors = o3d.utility.Vector3dVector(df[:,3:6]/255)
pcd.normals = o3d.utility.Vector3dVector(df[:,6:9])
